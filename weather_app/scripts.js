const NEWS_API_KEY = 'Your_Api_Key';
 const GEMINI_API_KEY ='Your_Api_key'
  ...
  function renderWeather(location, data) {
    ...
    currentWeatherContext = `City: ${location.name} , ${location.country}. Temprature: ${Math.round(c.temperature_2m)}°C Condition : ${WMO_DESC[code] || 'Unknown'}. Humidity : ${c.relative_humidity_2m}% Wind: ${c.wind_speed_10m} km/h`
  ...
  async function fetchAll() {
    ...
    async function sendMessage() {
        ...
        const systemContext = `You are a helpful assistant embedded in a weather and news dashboard called Infodash
         ...
         -News : ${currentNewsContext || 'No news loadded yet'}
         Keep answers concise and friendly . if user asks about weather or news , use the context above
        `
        const geminiMessage = history.slice(-9).map(m=>({
        ...
        <div class="msg ai">
            ...
            <div>
                <div class="msg-bubble">
                    Hello! I'm your AI assistant. Ask me anything about weather, news, or any topic you're curious about.
                </div>
